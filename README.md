...
1. Create a collection / table / store
2. Create a schema - Add required keys / columns
3. Start adding data as necessary

### How it works

1. QuickDB leverages the power of IndexedDB that comes with most modern browsers
